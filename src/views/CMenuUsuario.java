...
public class CMenuUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CMenuUsuario frame = new CMenuUsuario();
	 ...
	 */
	public CMenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(CMenuUsuario.class.getResource("/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(CMenuUsuario.class.getResource("/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(CMenuUsuario.class.getResource("/imagenes/reservado.png")));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				GBusqueda gBusqueda = new GBusqueda();
				gBusqueda.setVisible(true);
				dispose();
			}
		});
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(CMenuUsuario.class.getResource("/imagenes/pessoas.png")));
