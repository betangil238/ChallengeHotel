...
public class BLogin extends JFrame {
	...
	public BLogin() {
		...
		imgHotel.setIcon(new ImageIcon(BLogin.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				AMenuPrincipal cerrar= new AMenuPrincipal();
				cerrar.cerrar();
			}
			@Override
		...
		lblNewLabel_1.setIcon(new ImageIcon(BLogin.class.getResource("/imagenes/lOGO-50PX.png")));
	...
	private void Login() {
	     ...
	     clientes.put("admin", "admin");
	     System.out.println(clientes);
	     String contrase=new String (txtContrasena.getPassword());
	     String usuario=txtUsuario.getText();

	     if(clientes.containsKey(usuario) && clientes.get(usuario).equals(contrase)){
	            CMenuUsuario menu = new CMenuUsuario();
	            menu.setVisible(true);
	            dispose();	 
	        }
	     else {
	        	String botones[]= {"Cerrar","Registrar Usuario"};
	        	int eleccion = JOptionPane.showOptionDialog(this, "Usuario o Contraseña no válidos" , "Cerrar aplicacion", yMouse, xMouse, null, botones, botones);
	        	if(eleccion == JOptionPane.YES_OPTION) {
	        		setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
	        	}else if (eleccion==JOptionPane.NO_OPTION) {
	        		clientes.put(txtUsuario.getText(), contrase);
	        	}
	        }
	} 
